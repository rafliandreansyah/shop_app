...
class _AuthCardState extends State<AuthCard>
  ...
  late Animation<Offset> _animationTransition;
  ...
  void initState() {
    ...
    _animationTransition = Tween<Offset>(
    ...
    _animationFade = Tween(begin: 0.0, end: 1.0).animate(
